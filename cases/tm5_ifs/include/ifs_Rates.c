...
double fno3   = 0.90;    // fraction of NO3...
double fn2o5  = 0.10;    // fraction of N2O5
double rn2o5, rno3no2;
double prod,  loss;
...
double erh = 1. / 1.E3;
  ...
  rno3no2 = TROE_ifs(3.6E-30,4.1,1.9E-12,-0.2,10.,Mval,TEMP);
  rn2o5   = TROE_ifs2(1.3E-3,-3.5,9.7E14,0.1,10.,Mval,-11000.,
             -11080.,TEMP);
  fno3 = (rn2o5 + 2.5E-05)/(rno3no2*VAR[ind_NO2]+ rn2o5 +2.5E-05);
  fn2o5 = (1. - fno3);
...
/* End INLINED RCONST                                               */
  ...
  RCONST[9] = (TROE_no2oh(3.2E-30,4.5,3.E-11,10.,Mval,TEMP));
